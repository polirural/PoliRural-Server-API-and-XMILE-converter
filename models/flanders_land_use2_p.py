"""
Python model 'flanders_land_use2_p.py'
...
_namespace = {
    ...
    "energy_price_effect_on_profitability": "energy_price_effect_on_profitability",
...
_dependencies = {
    ...
    "intensive_farms_profitability": {
        "energy_price_effect_on_profitability": 1,
        "cap_effect_on_intensive_farm_profitability": 1,
    },
    "arable_land": {"arable_land_farms": 1, "arable_land_farms_average_size": 1},
    "energy_price_index": {"time": 1},
    "energy_price_effect_on_profitability": {"energy_price_index": 1},
...
def intensive_farms_profitability():
    ...
    Original Eqn: (energy_price_effect_on_profitability+CAP_effect_on_intensive_farm_profitability)/2
    Units: dmnl
    Limits: (None, None)
    Type: component
    Subs: None
    ...
    """
    return (
        energy_price_effect_on_profitability()
        + cap_effect_on_intensive_farm_profitability()
    ) / 2
...
def energy_price_index(x=None):
    """
    Real Name: energy_price_index
    Original Eqn: TIME
    Units: dmnl
    Limits: (None, None)
    Type: lookup
...
def energy_price_effect_on_profitability(x=None):
    """
    Real Name: energy_price_effect_on_profitability
    Original Eqn: energy_price_index
    Units: dmnl
    Limits: (None, None)
    Type: lookup
    Subs: None
